...
```
╔═══════════════════════════════════════════════════════╗
║           Arseny Perfilov  ·  Arsen1y-dev             ║
║      Data Science · ML · Full-Stack Development       ║
╚═══════════════════════════════════════════════════════╝
```

# Hi, I'm Arseny 👋

**3rd-year student** · Math & Information Systems · Saratov State University  
Specialization: **Big Data & Machine Learning**

[![Telegram](https://img.shields.io/badge/Telegram-@blessper-2CA5E0?style=flat-square&logo=telegram&logoColor=white)](https://t.me/blessper)
[![Email](https://img.shields.io/badge/Email-arsenij--perfilov@mail.ru-c0392b?style=flat-square&logo=gmail&logoColor=white)](mailto:arsenij-perfilov@mail.ru)
...
```python
perfilov = {
    "university": "Saratov State University (SGU)",
    "faculty":    "Computer Science & IT",
    "major":      "02.03.03 — Math & Information Systems",
    "focus":      "Big Data & Machine Learning",
    "year":       3,
    "learning":   ["Frontend Development (Yandex Practicum)"],
    "interests":  ["ML", "Data Analysis", "Web Scraping", "Dashboards"],
}
```
...
| Year | Award |
|------|-------|
| 2025 | 🥇 **1st place diploma** — "Digital Department" SGU graduate project competition · *Age prediction from photo* |
| 2024 | 🥉 **3rd place** — Sovcombank case championship "Liga Priklyucheniy 2024" · *SovcomPeople career site testing* |
